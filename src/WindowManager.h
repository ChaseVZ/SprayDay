...
public:
	...
	virtual void cursorPositionCallback(GLFWwindow* window, double xPos, double yPos) = 0; // >>>>> CHASE ADDED <<<<<<<
...
private:
	...
	static void cursor_callback(GLFWwindow* window, double xPos, double yPos); // >>>>> CHASE ADDED <<<<<<<
};
